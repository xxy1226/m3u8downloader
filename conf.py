...
default_langs = {
    'Русский':{
        ...
        'warn':'Внимание',
        'info':'Сообщение',
        'no_input':'Сначала введите URL-адрес или путь к файлу',
        'invalid_input':'Неверный URL/путь к файлу',
        'err_504':'не найдена (404)',
        'err_504':'Время ожидания шлюза (504)',
        'm3u8_not_found':'m3u8 не найден!',
        '':'',
    },
    'English':{
        'lang':'en-us',
        ...
        'warn':'Warning',
        'info':'Message',
        'no_input':'Please enter the URL or file path first!',
        'invalid_input':'Invalid URL / file path!',
        'err_404':'Not found (404)',
        'err_504':'Gateway Time-out (504)',
        'm3u8_not_found':'m3u8 not found!',
        '':'',
    },
    '中文':{
        'lang':'zh-cn',
        ...
        'info':'消息',
        'no_input':'没有可分析的内容！',
        'invalid_input':'不支持的地址！',
        'err_404':'无效网址 (404)',
        'err_504':'网关超时 (504)',
        'm3u8_not_found':'没有找到 m3u8 文件！',
        '':'',
    },
}
